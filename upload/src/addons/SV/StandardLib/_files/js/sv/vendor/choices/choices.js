...
exports.setIsLoading = exports.clearAll = void 0;
...
var items_1 = __webpack_require__(956);
...
var templates_1 = __importStar(__webpack_require__(543));
...
var Choices = /** @class */function () {
  function Choices(element, userConfig) {
    ...
    this._initialItems = this._store.activeItems.map(function (choice) {
      return choice.value;
    });
  }
  ...
  Choices.prototype.highlightItem = function (item, runEvent) {
    ...
    if (runEvent) {
      this.passedElement.triggerEvent("highlightItem" /* EventType.highlightItem */, this._getChoiceForEvent(id));
    }
    return this;
  };
  ...
  Choices.prototype._render = function () {
    ...
    var stateChanged = this._currentState.choices !== this._prevState.choices || this._currentState.groups !== this._prevState.groups || shouldRenderItems;
    if (!stateChanged) {
      return;
    }
    if (this._isSelectElement) {
  ...
  Choices.prototype._renderChoices = function () {
    ...
    if (choiceListFragment.childNodes && choiceListFragment.childNodes.length > 0) {
      ...
      if (canAddItem.response) {
        ...
        var notice = this._templates.notice(this.config, canAddItem.notice);
  ...
  Choices.prototype._createChoicesFragment = function (choices, fragment, withinGroup) {
    ...
    if (this._isSelectElement) {
      var backingOptions = choices.filter(function (choice) {
  ...
  Choices.prototype._getChoiceForEvent = function (id) {
    var choice = typeof id === 'object' ? id : this._store.choices.find(function (obj) {
      return obj.id === id;
    });
    if (!choice) {
      return undefined;
  ...
  Choices.prototype._handleChoiceAction = function (activeItems, element) {
    ...
    this.passedElement.triggerEvent("choice" /* EventType.choice */, {
      choice: choice
    });
  ...
  Choices.prototype._onKeyUp = function (_a) {
    ...
    if (this._isTextElement) {
      ...
      if (canShowDropdownNotice) {
        var dropdownItem = this._templates.notice(this.config, canAddItem.notice);
      ...
      var wasRemovalKeyCode = keyCode === 46 /* KeyCodeMap.BACK_KEY */ || keyCode === 8 /* KeyCodeMap.DELETE_KEY */;
  ...
  Choices.prototype._addItem = function (item, withEvents) {
    ...
    if (withEvents) {
      this.passedElement.triggerEvent("addItem" /* EventType.addItem */, this._getChoiceForEvent(item));
    }
  };
  Choices.prototype._removeItem = function (item) {
    ...
    this.passedElement.triggerEvent("removeItem" /* EventType.removeItem */, this._getChoiceForEvent(item));
  };
  ...
  Choices.prototype._createStructure = function () {
    ...
    this._store.withDeferRendering(function () {
      if (_this._isSelectElement) {
        _this._addPredefinedChoices(_this._presetChoices, _this._isSelectOneElement);
  ...
  Choices.prototype._addPredefinedChoices = function (choices, selectFirstOption, withEvents) {
    ...
    if (selectFirstOption) {
       ...
       */
      var hasSelectedChoice = choices.findIndex(function (choice) {
        return !!choice.selected;
      }) === -1;
...
var dropdown_1 = __importDefault(__webpack_require__(836));
exports.Dropdown = dropdown_1.default;
var container_1 = __importDefault(__webpack_require__(382));
exports.Container = container_1.default;
var input_1 = __importDefault(__webpack_require__(37));
exports.Input = input_1.default;
var list_1 = __importDefault(__webpack_require__(937));
exports.List = list_1.default;
var wrapped_input_1 = __importDefault(__webpack_require__(733));
exports.WrappedInput = wrapped_input_1.default;
var wrapped_select_1 = __importDefault(__webpack_require__(129));
...
var WrappedSelect = /** @class */function (_super) {
  ...
  WrappedSelect.prototype._optionToChoice = function (option) {
    var result = {
      ...
      labelClass: typeof option.dataset.labelClass !== 'undefined' ? (0, choice_input_1.stringToHtmlClass)(option.dataset.labelClass) : undefined,
...
exports.SCROLLING_SPEED = exports.SELECT_MULTIPLE_TYPE = exports.SELECT_ONE_TYPE = exports.TEXT_TYPE = void 0;
...
exports.mapInputToChoice = exports.stringToHtmlClass = void 0;
var utils_1 = __webpack_require__(705);
...
exports.stringToHtmlClass = stringToHtmlClass;
var mapInputToChoice = function (value, allowGroup) {
  if (typeof value === 'string') {
    var result_1 = (0, exports.mapInputToChoice)({
      value: value,
      label: value
    }, false);
    return result_1;
  ...
  var result = {
    ...
    highlighted: false,
    labelClass: (0, exports.stringToHtmlClass)(choice.labelClass),
    labelDescription: choice.labelDescription,
    customProperties: choice.customProperties
  };
  return result;
...
var items_1 = __importDefault(__webpack_require__(864));
var groups_1 = __importDefault(__webpack_require__(998));
var choices_1 = __importDefault(__webpack_require__(556));
var loading_1 = __importDefault(__webpack_require__(280));
var utils_1 = __webpack_require__(705);
exports.defaultState = {
  groups: [],
  items: [],
...
var rootReducer = function (passedState, action) {
  ...
  if (action.type === "CLEAR_ALL" /* ActionType.CLEAR_ALL */) {
    ...
    state = (0, utils_1.cloneObject)(exports.defaultState);
...
exports.escapeForTemplate = void 0;
var utils_1 = __webpack_require__(705);
...
var templates = {
  ...
  placeholder: function (_a, value) {
    ...
    return Object.assign(document.createElement('div'), {
      ...
      innerHTML: (0, exports.escapeForTemplate)(allowHTML, value)
    });
  },
  ...
  notice: function (_a, innerText, type) {
    ...
    return Object.assign(document.createElement('div'), {
      innerHTML: (0, exports.escapeForTemplate)(allowHTML, innerText),
